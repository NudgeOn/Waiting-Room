    ...
    <div className="rw-layout"><form className="rw-form" noValidate ref={form} onSubmit={submit}>
      ...
      <fieldset disabled={busy} className="rw-fields"><legend className="rw-sr-only">{current.label} 설정</legend>
        ...
        {step===4?<>
          ...
          <div className="rw-after-save"><strong>저장 후 남은 단계</strong><ol><li><span>1</span>원본 연결과 보호 경로 확인</li><li><span>2</span>설정 배포 및 적용 상태 확인</li><li><span>3</span>입장 흐름 검증 후 운영 시작</li></ol><p>현재 화면은 초안만 저장합니다. 원본 연결 검사·서명 배포·대기열 활성화는 실행하지 않습니다. Quick 20 자동 검증은 아직 연결되지 않았습니다.</p></div>
