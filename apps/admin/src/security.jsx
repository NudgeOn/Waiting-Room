...
export default function Security({session,csrf,onBack,onEnrollment,onSessionChanged}) {
  ...
  return <div className="control-workspace"><div className="control-toolbar"><h2 tabIndex={-1} ref={heading}>사용자 · 보안 설정</h2><button className="text-button" disabled={Boolean(request)} onClick={onBack}>대기열 목록으로</button></div>
