...
redis.register_function('wr_pg3_check',function(keys,args)
  ...
  -- Quota/poll time may pause for a subsecond clock correction, never rewind.
  -- This does not authorize queue operations or alter their clock/fence checks.
  if now<old then
